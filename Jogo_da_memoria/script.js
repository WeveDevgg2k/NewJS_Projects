...
function showCongratsMessage() {
  const congratulationMessage = document.querySelector(".congratulations")
  const congratsElement = document.createElement('p')
  congratsElement.classList.add('congratulations-message')
  congratsElement.textContent = `Você venceu o jogo com ${attempts} tentativas`
  congratulationMessage.append(congratsElement)
}
